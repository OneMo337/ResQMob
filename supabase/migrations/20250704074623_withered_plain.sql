...
INSERT INTO sos_alerts (id, user_id, type, urgency_level, status, location, message, timestamp, confirmations, escalation_level, notification_radius, is_anonymous) VALUES
...
INSERT INTO sos_responders (id, user_id, alert_id, status, distance, timestamp, estimated_arrival) VALUES
...
INSERT INTO feed_posts (id, user_id, content, type, timestamp, location, likes, comments, shares, tags, visibility, is_verified) VALUES
...
INSERT INTO messages (id, chat_room_id, sender_id, content, type, timestamp, is_edited) VALUES
...
INSERT INTO notifications (id, user_id, type, title, body, data, is_read, timestamp, priority) VALUES
